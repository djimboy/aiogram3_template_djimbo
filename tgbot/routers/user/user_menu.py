...
async def user_button_inline(message: Message, bot: Bot, state: FSMContext, rSession: RS, user: UserDB):
    await state.clear()
...
async def user_button_reply(message: Message, bot: Bot, state: FSMContext, rSession: RS, user: UserDB):
    await state.clear()
...
async def user_command_inline(message: Message, bot: Bot, state: FSMContext, rSession: RS, user: UserDB):
    await state.clear()
